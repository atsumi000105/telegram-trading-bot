...
IBM_path = 'C:\\Users\\Vlad\\Desktop\\Finance\\ADA 15 min.csv'

df = pd.read_csv(IBM_path, delimiter=',', usecols=['Close Time', 'Open', 'High', 'Low', 'Close', 'Volume'])
...
# Remove date column
df_train.drop(columns=['Close Time'], inplace=True)
df_val.drop(columns=['Close Time'], inplace=True)
df_test.drop(columns=['Close Time'], inplace=True)
